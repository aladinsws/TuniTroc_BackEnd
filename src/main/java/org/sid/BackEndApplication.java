...
import org.sid.dao.*;
import org.sid.elasticsearch.RechercheRepository;
...
//
    ...
    @Bean
    CommandLineRunner start(GestionAnnonceRepository gestAnnonce, GestionAbonneRepository gestAbonne, CategorieRepository categoryRepo, SousCategorieRepository subCategoryRepo, AnnonceRepository annonceRepo,RechercheRepository rechercheRepo){
        return args -> {
